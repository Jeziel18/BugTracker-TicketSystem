...
import TimeAndDateENG from "../TimeAndDate/TimeAndDateENG";
...
const CreateReport: React.FC<Props> = ({ user_id }) => {
  ...
  const Decanato = [
    { value: "Decanato de Administracion", label: "Decanato de Administracion" },
    { value: "Decanato de Estudiantes", label: "Decanato de Estudiantes" },
    { value: "Decanato de Asuntos Academicos", label: "Decanato de Asuntos Academicos" },
  ];
        ...
        loading ?
            ...
            <div className="mt-1 mb-2 p-2">
              <div className="fs-3 fw-bolder text-decoration-underline">
                <span>Department of Buildings and Grounds</span>
              </div>
              <div className="container-fluid mt-1 mb-2 p-0">
                ...
                <div className="row mb-2 mt-3">
                  <div className="col-sm-3">
                    ...
                    >
                      <span className="text-danger me-2">*</span>
                      <span>Office Number, Room or Classroom:</span>
                    </label>
                  </div>
